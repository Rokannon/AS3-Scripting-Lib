package com.newgonzo.scripting.utils
{
    ...
    {
        private static const SWF_START:Array = [0x46, 0x57, 0x53, 0x09, 0xff, 0xff, 0xff, 0xff, 0x78, 0x00, 0x03, 0xe8, 0x00, 0x00, 0x0b, 0xb8, 0x00, 0x00, 0x0c, 0x01, 0x00, 0x44, 0x11, 0x08, 0x00, 0x00, 0x00];

        private static const ABC_HEADER:Array = [0x3f, 0x12];

        private static const SWF_END:Array = [0x40, 0x00];
