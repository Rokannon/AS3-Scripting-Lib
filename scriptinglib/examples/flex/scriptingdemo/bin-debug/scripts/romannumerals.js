...
var intToConvert = 33;
var expectedRom = "XXXIII";
var actualRom = parseIntToRoman(intToConvert);

var romToConvert = "XXIV";
var expectedInt = 24;
var actualInt = parseRomanToInt(romToConvert);

console.print("int: " + intToConvert);
console.print("expected:  "  + expectedRom);
console.print("actual: " + actualRom);
console.print("expected == actual: " + (expectedRom == actualRom));
console.print("");
console.print("roman: " + romToConvert);
console.print("expected: " + expectedInt);
console.print("actual: " + actualInt);
console.print("expected == actual: " + (expectedInt == actualInt));